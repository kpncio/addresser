	...
	echo "
		...
		<html lang='en'>
			<head>
				...
				<meta name='description' content='APROX Project: Addressio: IP Address Lookup...'>
				<meta name='viewport' content='width=device-width, height=device-height, initial-scale=1.0'>
				<meta http-equiv='X-UA-Compatible' content='ie=edge'>
				<link href='https://cdn.aprox.us/' rel='preconnect'>
				<link href='https://cdn.aprox.us/css/addressio.css' rel='stylesheet'>
				<link href='https://cdn.aprox.us/css/roboto-mono.css' rel='stylesheet'>
				<link href='https://cdn.aprox.us/img/aprox3/aproxiconorg.png' rel='icon'>
				<link href='https://cdn.aprox.us/lib/leaflet/leaflet.css' rel='stylesheet'>
				<script src='https://cdn.aprox.us/lib/leaflet/leaflet.js'></script>
			</head>
			<body>
				...
				<main>
					<header>
						<a href='https://www.aprox.us' target='_blank'>
							<img src='https://cdn.aprox.us/img/aprox4/aproxlogoblkhires.webp' alt='///APROX'>
						</a>
					</header>
					...
					<footer>
						<small>&copy; 2022 APROX Project // Addressio: <a href='https://github.com/APROXUS/addressio' target='_blank'>GitHub</a></small>
					</footer>
				</main>
				...
				<script>
					...
					var tiles = L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
						maxZoom: 18,
						attribution: 'Map Data & Imagery &copy; <a href='https://www.openstreetmap.org/copyright'>OpenStreetMap</a> & <a href='https://www.mapbox.com/'>Mapbox</a>',
